...
Accuracy declined to 99.43% but it's still very good. I should note that it's impossible to test the model on testing dataset since it doesn't have "classe" column.